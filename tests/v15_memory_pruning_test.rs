...
use prometheos::flow::memory::{MemoryScore, MemorySummarizer, prune, prune_by_threshold, prune_combined, rank_memories};
use prometheos::flow::memory::types::{Memory, MemoryKind};
...
#[test]
fn test_summarizer_single_memory() {
...
#[test]
fn test_summarizer_compress_clusters() {
    let summarizer = MemorySummarizer::default();
    let memories = vec![
        create_test_memory(0.5, 1, 10),
        create_test_memory(0.5, 1, 10),

...
pub trait FlowPerformanceOperations {
    ...
    fn get_performance_by_work_context(
        &self,
        work_context_id: &str,
    ) -> Result<Vec<FlowPerformanceRecord>>;
    ...
    fn get_latest_performance(
        &self,
        work_context_id: &str,
    ) -> Result<Option<FlowPerformanceRecord>>;
    ...
    fn delete_old_performance_records(
        &self,

...
Queue approved and defined. Not yet executed. This PR (#72) is the queue/specs PR only; the implementation is a separate follow-up PR (#73) per the established loop pattern (queue first, execute second).

...
- [ ] Exact-commit core/platform/smoke evidence verifies on an owned machine
- [ ] Exact-commit platform evidence verifies on every owned release target (Linux, macOS, and Windows); any unavailable target is explicitly disclosed and approved
